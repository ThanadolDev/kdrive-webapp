...
export const MainDrive = ({ fetchstate, folderId, fetchheader, shareStatus }) => {
    const {
        activeMenu,
        isModalOpen,
        openModal,
    ...
    const containerClassName = `m-4 bg-white rounded-md overflow-auto h-[90vh] drop-shadow-sm ${isDragActive
            ...
            <div className={containerClassName} {...getRootProps()}>
              ...
              <label className="cursor-pointer">
                ...
                />
                    ...
                    {fetchError && 
                    <div>Fetching error. Try again later</div>
                    }
                </div>
            </div>
