...
export const MainDrive = ({ fetchstate, folderId, fetchheader }) => {
  ...
  const containerClassName = `m-4 bg-white rounded-md overflow-auto h-[91vh] drop-shadow-sm ${
    isDragActive
      ? "m-4 border-dashed bg-blue-100  border-4 border-gray-300"
      : ""
  }`;
  return (
    <>
        ...
        <div className="p-8">
          <div className="mb-8 flex items-center">
            <div
              ...
              className="mr-2 p-0.5 hover:bg-gray-200 rounded-md"
            >
                ...
                <div>
                  <Box>
                    ...
                    <div
                      ...
                      className="ml-auto hover:bg-gray-400 p-0.5 ml-40 mt-3 rounded-xl absolute"
                    >
      ...
      <Modals isOpen={editfoldernamemodal} onClose={closeeditfolder}>
        ...
        <div className="mb-2">Edit Folder Name</div>
        <div class="w-full mb-6 md:mb-0">
          <input
            class="appearance-none block w-full bg-gray-200 text-gray-700 border  rounded p-2 mb-3 focus:outline-none focus:bg-white"
            type="text"
